...
extension Gradient {
    ...
    /// stats-panel bezel (`StatsPanel`), so both catch light the same way. Rendered as a
    /// conic/angular gradient whose angle is nudged by device tilt at the call site.
